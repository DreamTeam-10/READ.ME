...
**[OWASP](https://owasp.org)** — Top 10 for Agentic Applications and related application security guidance. Core to the framework stack used throughout this repo (see [`docs/framework-reference.md`](../docs/framework-reference.md)).
